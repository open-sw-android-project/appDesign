...
public class ScanPage extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ScanPage.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 0);
            System.out.println("\n\n\nno location\n\n\n");
        }
        else{
            try {
...
//                                lm.removeUpdates(mLocationListener);  //  미수신할때는 반드시 자원해체를 해주어야 한다.
        ...
        subName.setText("현재 출석 진행중인 수업: " + SubjectName +"(" + SubjectCode + ")");
        ...
        attendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(), ShowAttendActivity.class);
